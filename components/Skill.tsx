  ...
  return (
    <div className="text-black group relative cursor-pointer ">
      <motion.img
        ...
        src={src}
        className={
          "rounded-full shadow-xl shadow-gray-500  border border-black object-contain w-16 h-16  xl:w-24 xl:h-24 md:w-20 md:h-20 filter group-hover:grayscale transition duration-300 ease-in-out "
        }
      />
